...
class TwoLayerNet(object):
  ...
  def train(self, X, y, X_val, y_val,
    ...
    for it in xrange(num_iters):
      ...
      #########################################################################
      '''
      print('self b1:',self.params['b1'].shape, 'grads b1:', grads['b1'].shape)
      print('self W1:',self.params['W1'].shape, 'grads W1:', grads['W1'].shape)
      print('self b2:',self.params['b2'].shape, 'grads b2:', grads['b2'].shape)
      print('self W2:',self.params['W2'].shape, 'grads W2:', grads['W2'].shape)
      '''
